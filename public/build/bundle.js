...
var app = (function () {
    ...
    /* src\population\AxisBottom.svelte generated by Svelte v3.37.0 */
    ...
    // (6:0) {#each xScale.ticks() as tickValue}
    function create_each_block(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*xScale*/ 1 && t_value !== (t_value = format(".2s")(/*tickValue*/ ctx[2]).replace("G", "B") + "")) set_data(t, t_value);

    			if (dirty & /*innerHeight*/ 2 && text_1_y_value !== (text_1_y_value = /*innerHeight*/ ctx[1] + 5)) {
    				attr(text_1, "y", text_1_y_value);
    			}

    			if (dirty & /*xScale*/ 1 && g_transform_value !== (g_transform_value = `translate(${/*xScale*/ ctx[0](/*tickValue*/ ctx[2])}, ${0})`)) {
    ...
    function create_fragment(ctx) {
    	let each_1_anchor;
    	let each_value = /*xScale*/ ctx[0].ticks();
    	let each_blocks = [];
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*xScale, innerHeight, d3*/ 3) {
    				each_value = /*xScale*/ ctx[0].ticks();
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { xScale } = $$props, { innerHeight } = $$props;
    	...
    	return [xScale, innerHeight];
    }

    class AxisBottom extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { xScale: 0, innerHeight: 1 });
    	}
    }

    /* src\population\AxisLeft.svelte generated by Svelte v3.37.0 */
    ...
    // (5:0) {#each yScale.domain() as tickValue}
    function create_each_block$1(ctx) {
    	let g;
    	let text_1;
    	let t_value = /*tickValue*/ ctx[5] + "";
    	let t;
    	let text_1_x_value;
    	let text_1_dy_value;
    	let g_transform_value;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*yScale*/ 1 && t_value !== (t_value = /*tickValue*/ ctx[5] + "")) set_data(t, t_value);

    			if (dirty & /*yScale*/ 1 && g_transform_value !== (g_transform_value = `translate(${0}, ${/*yScale*/ ctx[0](/*tickValue*/ ctx[5]) + /*yScale*/ ctx[0].bandwidth() / 2})`)) {
    				attr(g, "transform", g_transform_value);
    			}
    		},
    		d(detaching) {
    ...
    function create_fragment$1(ctx) {
    	let each_1_anchor;
    	let each_value = /*yScale*/ ctx[0].domain();
    	let each_blocks = [];
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*yScale*/ 1) {
    				each_value = /*yScale*/ ctx[0].domain();
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("xValue" in $$props) $$invalidate(3, xValue = $$props.xValue);
    		if ("yValue" in $$props) $$invalidate(4, yValue = $$props.yValue);
    	};

    	return [yScale, data, xScale, xValue, yValue];
    }

    class AxisLeft extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    /* src\population\Marks.svelte generated by Svelte v3.37.0 */
    ...
    function create_each_block$2(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*yScale*/ 2 && rect_height_value !== (rect_height_value = /*yScale*/ ctx[1].bandwidth())) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			svg = svg_element("svg");
    			g = svg_element("g");
    			create_component(axisbottom.$$.fragment);
    		...
    		m(target, anchor) {
    			...
    			append(div, svg);
    			append(svg, g);
    			mount_component(axisbottom, g, null);
    			mount_component(axisleft, g, null);
    			append(g, text_1);
    			append(text_1, t0);
    			append(text_1, t1);
    			append(text_1, t2);
    			mount_component(marks, g, null);
    			current = true;
    		},
    		p(ctx, dirty) {
    		...
    		i(local) {
    			if (current) return;
    			transition_in(axisbottom.$$.fragment, local);
    			transition_in(axisleft.$$.fragment, local);
    			transition_in(marks.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(axisbottom.$$.fragment, local);
    			transition_out(axisleft.$$.fragment, local);
    			transition_out(marks.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			if (detaching) detach(div);
    			destroy_component(axisbottom);
    			destroy_component(axisleft);
